# Contributing to pyfocusr

Thank you for considering to contribute to `pyfocusr`.
...
### Found a bug?
We would very much appreciate if you could **make sure the bug was not already reported** (use the search bar on Github under Issues). If you cannot find you bug, follow the instructions in the [Bug Report](https://github.com/gattia/pyfocusr/issues/new/choose) template.
...
If your issue is well written we're already 80% of the way there by the time you post it. Follow the instructions in the [Feature Request](https://github.com/gattia/pyfocusr/issues/new/choose)  
...
1. Fork the [`repository`](https://github.com/gattia/pyfocusr) by clicking on the 'Fork' button the repository's page. This creates a copy of the code under your GitHub user account.

2. Clone your fork to your local disk, and add the base repository as a remote:

   ```bash
   $ git clone git@github.com:<your Github handle>/pyfocusr.git 
   $ cd pyfocusr
   $ git remote add upstream https://github.com/gattia/pyfocusr.git
   ```

3. Create a development branch - all changes should merged with the `pyfocusr`-`development` branch: 
...
[tests folder](https://github.com/gattia/pyfocusr/tree/main/testing).
...
### Style guide
`pyfocusr` does not currently have proper/extensive documentation.  

Automatically building documentation, and re-building figures would be a great addition to the `pyfocusr`.
